...
def run_test_program():
    ...
    proc = subprocess.Popen(["../test_code/openMP"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
if __name__ == "__main__":
    # 记录不加 OpenMP 环境变量时的 CPU 使用情况
    print("Starting experiment with openMP...")
    ...
    print("With openMP CPU usage percentages:", no_omp_data)
    save_data_to_file('cpu_usage_data.txt', 'openMP', no_omp_data)
    # 程序结束
    print("Ending script.")
    exit()
