...
#include <stdio.h>
    ...
    // #endif 
    #if defined(_XOPEN_SOURCE) && _XOPEN_SOURCE >= 500 && (!defined(_POSIX_C_SOURCE) || _POSIX_C_SOURCE < 200809L) || defined(_DEFAULT_SOURCE) || defined(_BSD_SOURCE)
    typedef int (*usleep_t)(useconds_t usec);
    #endif
    ...
    #if defined(_POSIX_C_SOURCE) && _POSIX_C_SOURCE >= 199309L   // https://man7.org/linux/man-pages/man2/nanosleep.2.html
